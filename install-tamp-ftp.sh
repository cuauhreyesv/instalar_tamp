...
show_banner() {
    ...
    echo "║           Navegador: DESACTIVADO al inicio                ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
start_service "TAMP Web Server" "httpd" "tamp start"
...
start_service "FTP Server (2221)" "pyftpdlib" "cd /sdcard/htdocs && python3 -m pyftpdlib -p 2221 -u android -P android -w"
...
# ============================================
# APERTURA DE NAVEGADOR - DESACTIVADA
# ============================================
# Para activar el navegador automáticamente, quita los comentarios (#) de las siguientes líneas:
#
# if [ -n "$IP" ]; then
#     echo ""
#     echo "🌐 Abriendo navegador con la dirección local..."
...
# else
#     echo ""
#     echo "📱 Para acceder al servidor web:"
...
# Navegador: DESACTIVADO al inicio
# ============================================
if [ -f ~/iniciarservicios ]; then
    ...
    if [[ $- == *i* ]]; then
        ...
        if [ $SERVICES_NEEDED -eq 1 ]; then
            ...
            echo ""
            # NOTA: Navegador desactivado por defecto
            # Para activar navegador automático, edita ~/iniciarservicios
...
# 9. EJECUTAR SERVICIOS POR PRIMERA VEZ
...
# 13. CREAR ARCHIVO DE CONFIGURACIÓN MEJORADO
...
🔄 AUTO-INICIO MEJORADO:
   ...
   Para activar navegador automático:
      nano ~/iniciarservicios
      # Quita los comentarios (#) de la sección "APERTURA DE NAVEGADOR"
...
⚡ NOVEDADES v3.0:
   • Auto-inicio mejorado: Siempre funciona
   • Script de verificación: ~/check_services
   • Termux-boot configurado: Inicia tras reinicio del sistema
   • phpMyAdmin reparado: TCP como HeidiSQL
   • Navegador: DESACTIVADO al inicio por defecto
...
echo ""
echo "✅ NAVEGADOR AL INICIO"
echo "   • Estado: DESACTIVADO"
echo "   • Para activar: Edita ~/iniciarservicios"
...
echo "4. Verifica con: ~/check_services"
echo "5. Navegador: NO se abrirá automáticamente"

echo ""
echo "🌐 CÓMO ABRIR MANUALMENTE EL NAVEGADOR:"
echo "════════════════════════════════════════"
echo "1. Abre tu navegador favorito"
echo "2. Ve a: http://localhost:8080"
echo "3. O usa: http://127.0.0.1:8080"
echo ""
echo "Para activar apertura automática:"
echo "nano ~/iniciarservicios"
echo "# Quita los comentarios (#) de la sección 'APERTURA DE NAVEGADOR'"
...
echo ""
echo "Para activar navegador automático:"
echo "1. Edita: nano ~/iniciarservicios"
echo "2. Busca: 'APERTURA DE NAVEGADOR - DESACTIVADA'"
echo "3. Quita los comentarios (#) de las líneas indicadas"
echo "4. Guarda y reinicia: ~/iniciarservicios"
