...
# ============================================
if [ -f ~/inciarservicios ] && [ ! -f ~/.servers_auto_started ]; then
    echo ""
    ...
    (~/inciarservicios > ~/startup.log 2>&1 &)
fi
BASHRC_EOF
...
🚀 COMANDOS DE CONTROL:
   ...
   ▸ ~/inciarservicios   # Iniciar todos los servicios
