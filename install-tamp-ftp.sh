...
show_banner() {
    ...
    echo "║           Navegador: NO SE ABRE automáticamente           ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
echo "   • No abre navegador automáticamente"
echo ""
...
if [ -f ~/iniciarservicios ]; then
    ...
    if [[ $- == *i* ]]; then
        ...
        if [ $SERVICES_NEEDED -eq 1 ]; then
            ...
            echo ""
            # Ejecutar en segundo plano - SIN ABRIR NAVEGADOR
...
echo "   • NO abre navegador automáticamente"
echo "   • Solo muestra mensajes informativos"
...
# Ejecutar auto-inicio (solo en background, sin navegador)
bash ~/iniciarservicios > ~/first_start.log 2>&1 &
...
echo ""
echo "✅ NAVEGADOR"
echo "   • Estado: NO se abre automáticamente"
echo "   • Para acceder: Abre tu navegador manualmente"
